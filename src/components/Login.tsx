    ...
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <div className="flex-1 flex items-center justify-center p-6">
        <div className="w-full max-w-md space-y-8">
          ...
          {/* Login Card */}
          <Card className="shadow-2xl shadow-blue-500/10 dark:shadow-none border-0 bg-white/20 dark:bg-gray-900/90 backdrop-blur-xl ring-1 ring-gray-200/50 dark:ring-gray-800/50">
            <CardHeader className="space-y-2 pt-6 px-6 pb-0">
            ...
            <CardContent className="space-y-6">
              <Button
                variant="outline"
                className="w-full h-14 text-base font-semibold border-2 border-gray-200 dark:border-gray-700 hover:border-blue-300 dark:hover:border-blue-600 hover:bg-blue-50 dark:hover:bg-blue-950/30 text-gray-900 dark:text-white shadow-sm hover:shadow-md"
